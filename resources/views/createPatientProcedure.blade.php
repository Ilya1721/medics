  ...
  <div class="row justify-content-center">
    <div class="col-md-8">
      <div class="card">
        ...
        <div class="card-body">
          <form method="POST" action="/patient/{{ $patient->id }}/procedure">
            @csrf
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                  <input id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description" description="{{ old('description') }}" autocomplete="description" autofocus>
